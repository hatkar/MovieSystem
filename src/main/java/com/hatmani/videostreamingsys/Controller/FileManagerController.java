...
/***** PARTIE GETTING MOVIE *****/
    ...
    public Mono<Resource>downloadvideo(@PathVariable String dir,@PathVariable String fileName)
    {//download video
    ...
    public Mono<Resource>streamvideo(@PathVariable String dir,@PathVariable String fileName ,@RequestHeader("Range") String range)
    {//Streamin de video
